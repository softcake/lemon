...
package org.softcake.lemon.core.integtest;
...
public class PrivateConstructorTesterParametersIntegTest {
    ...
    @Test
    public void expectedWithNullParameters_defaultWithParameter_assert() {

        Class<DefaultParameterPrivate> aClass = DefaultParameterPrivate.class;
        thrown.expect(IllegalArgumentException.class);
        thrown.expectMessage("Parameter [expectedParameters] must not be null or empty!");
    ...
    @Test
    public void expectedWithNullParameters_defaultWithParameterNotMatch_throw() {

        Class<DefaultParameterPrivate> aClass = DefaultParameterPrivate.class;
        thrown.expect(IllegalArgumentException.class);
        thrown.expectMessage("Parameter [expectedParameters] must not be null or empty!");

        PrivateConstructorTester.forClass(aClass).expectedWithParameters().check();
    }

    @Test
    public void expectedWithNullParameters_nonstaticWithParameter_assert() {
        ...
        thrown.expect(IllegalArgumentException.class);
        thrown.expectMessage("Parameter [expectedParameters] must not be null or empty!");
        PrivateConstructorTester.forClass(nestedClass, enclosingInstance).expectedWithParameters().check();
    }

    @Test
    public void expectedWithNullParameters_nonstaticWithParameterNotMatch_throw() {
    ...
    @Test
    public void forClass_defaultWithNullParameterNotMatch_throw() {
    ...
    @Test
    public void forClass__nonstaticWithNullParameterNotMatch_throw() {
